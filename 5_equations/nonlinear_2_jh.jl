...
#root found after 13 iterations and evaluating function and Jacobian 14 times

#look at left corner -> Julia
#object r" - you can access it
r.method
r.zero
r.trace
r.trace.states #returns same thing as before
r.trace.states[1] #we can get guesses of different iterations
r.trace.states[8]
r.trace.states[8].metadata
r.trace.states[8].metadata["x"] #finally I got to x of the iteration
#you have to use the panel on the left to dig where a given object you'rea searching for is stored
